...
global.channelLink = "https://whatsapp.com/channel/0029VbBaL3BIN9iutL3i200Z";
global.ytch = "Masky_Official_Tech";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        // Check owner status for owner ⎋sᴛᴀʀ xᴅ
        if (isOwnerCommand) {
        ...
        // Add this near the start of your message handling logic, before processing ⎋sᴛᴀʀ xᴅ
        try {
     ...
     //           break;
        ...
        //    case userMessage.startsWith('.autostatus'):
            ...
            case userMessage.startsWith('.tiktok') || userMessage.startsWith('.tt'):
                ...
                break;
            case userMessage.startsWith('.gpt') || userMessage.startsWith('.masky'):
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363424398917353@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363424398917353@newsletter';
